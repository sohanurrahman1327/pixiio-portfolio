      ...
      <div className="max-w-7xl mx-auto px-6">
        {showTitle && (
          <div className="text-center mb-16">
            ...
            <h2 className="font-display text-[clamp(2.5rem,5vw,4rem)] leading-tight tracking-wide text-[#0f1a3d] mb-4">
              QUICK HELP
            </h2>
          ...
          <div className="hidden lg:flex flex-col gap-6">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-3xl p-8">
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  <p className="font-display text-xl leading-tight text-[#0f1a3d] font-bold">
                    STILL HAVE
                  </p>
              ...
              <div className="space-y-3">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-bold text-[#0f1a3d]">Ask Your Question</p>
                ...
                <Link
                  ...
                  target="_blank"
                  className="flex items-center justify-between p-4 bg-white rounded-xl border border-gray-200 hover:border-green-500 hover:shadow-md transition-all group"
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-bold text-[#0f1a3d]">Chat on WhatsApp</p>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-bold text-[#0f1a3d]">Prefer email?</p>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-3xl p-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-bold text-sm text-[#0f1a3d] mb-1">
                ...
                <article key={faq.question}>
                  ...
                  >
                    <div className="flex items-center gap-4 flex-1">
                      ...
                      <span className="text-base font-bold text-[#0f1a3d] group-hover:text-primary transition-colors">
                        {faq.question}
                      </span>
                    </div>
